...
export const CHAPTERS: ChapterMeta[] = [
  ...
  },
  {
    ...
    subtitle: "MLP sebagai pengubah bentuk tensor, pencocokan output head dan loss",
    weeks: "1",
    weekNumbers: [1],
    sikap: ["curiosity"],
  ...
  },
  {
    ...
    subtitle: "Tensor citra, CNN, smoke test tiga level",
    weeks: "2",
    weekNumbers: [2],
  ...
  },
  {
    ...
    subtitle: "Matriks eksperimen, YAML/seed/checkpoint, logging",
    weeks: "4",
    weekNumbers: [4],
    sikap: ["rigor"],
  ...
  },
  {
    ...
    subtitle: "Taksonomi modalitas × keluarga model × adaptasi, evaluasi platform",
    weeks: "8",
    weekNumbers: [8],
    sikap: ["curiosity"],
  ...
  },
  {
    ...
    subtitle: "Fusion, ablation per modalitas, modalitas hilang",
    weeks: "9",
    weekNumbers: [9],
    sikap: ["curiosity"],
  ...
  },
  {
    ...
    subtitle: "Framework Input→Middle→Output, framing menu, literature triage",
    weeks: "11",
    weekNumbers: [11],
...
export const COMPETENCIES: CompetencyMeta[] = [
  ...
  { n: 6, title: "Adopsi repository riset eksternal",          weeks: "W7, W10, Capstone",    chapters: ["07","10","12"] },
